...
ROLE_PERMISSIONS = {
    "agent":      {"can_see_own_agent_only": True,  "can_act_on_alerts": True,  "can_close_fraud": False, "can_dispatch": False, "can_see_all_providers": True},
    "ops":        {"can_see_own_agent_only": False, "can_act_on_alerts": True,  "can_close_fraud": False, "can_dispatch": True,  "can_see_all_providers": True},
    "risk":       {"can_see_own_agent_only": False, "can_act_on_alerts": True,  "can_close_fraud": True,  "can_dispatch": False, "can_see_all_providers": True},
    "provider":   {"can_see_own_agent_only": False, "can_act_on_alerts": False, "can_close_fraud": False, "can_dispatch": False, "can_see_all_providers": False},
    "management": {"can_see_own_agent_only": False, "can_act_on_alerts": False, "can_close_fraud": False, "can_dispatch": False, "can_see_all_providers": True},
}
